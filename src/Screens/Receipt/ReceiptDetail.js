...
export default function ReceiptDetails() {
  ...
  const printReceipt = () => {
    const invoiceDateDiv = document
      .querySelector("#invoice-date")
      .closest(".col-lg-3");
              ...
              <div className="row">
                    ...
                    <div className="d-flex">
                      ...
                      <div>
                        <div className="col-lg-12 col-12 ">
                          <p
                            className="text-muted mb-2 text-uppercase fw-semibold m-1"
                            style={{ display: "inline-block" }}>
                            Date
                          </p>
                          <h5
                            className="fs-14 mb-0 m-1 invoice-date"
                            style={{ display: "inline-block" }}>
                ...
                <div className="col-lg-12 ">
                  <div className="card-body p-4 border-top border-top-dashed">
                    <div className="row g-3 d-flex justify-content-sm-between">
                      <div className="col-5">
